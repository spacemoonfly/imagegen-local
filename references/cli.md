...
export IMAGE_GEN="$CODEX_HOME/skills/imagegen-local/scripts/image_gen.py"
```
...
- Built-in-first transparent image workflow: `SKILL.md` and `$CODEX_HOME/skills/imagegen-local/scripts/remove_chroma_key.py`
